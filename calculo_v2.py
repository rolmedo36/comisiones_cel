...
def calcular_comisiones_por_vendedor(
    db_path: str,
    presupuesto_mensual_global: float,
    year: int,
    month: int
):
    ...
    for vendedor, grupo in ventas.groupby('vendedor'):
        ...
        # === ESQUEMA 1: Comisión por cumplimiento del presupuesto ===
        # Aquí usamos el presupuesto global para calcular el porcentaje
        porcentaje_cumplimiento = (venta_total_vendedor / presupuesto_mensual_global) * 100 if presupuesto_mensual_global > 0 else 0
        ...
        # JUGUETES: familia_comercial = 'juguete', marca NO empieza con 'CXO', precio > 1500
        juguetes = grupo[
    ...
    for res in resultados:
        ...
        INSERT INTO comisiones_por_vendedor (
            vendedor, mes, anio, presupuesto_mensual,
...
if __name__ == "__main__":
    ...
    PRESUPUESTO_GLOBAL = 100000.0  # Este es el presupuesto mensual global
    YEAR = 2025
    MONTH = 10

    print(f"🔍 Calculando comisiones por vendedor para {MONTH}/{YEAR}...")
    resultados = calcular_comisiones_por_vendedor(DB_PATH, PRESUPUESTO_GLOBAL, YEAR, MONTH)
